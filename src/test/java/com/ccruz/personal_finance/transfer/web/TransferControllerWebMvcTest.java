...
@ActiveProfiles("test")
@DisplayName("TransferController - @WebMvcTest")
class TransferControllerWebMvcTest {
    ...
    @BeforeEach
    void setUp() {
        Mockito.reset(transferService, transferMapper);
    }
    ...
    @Test
    @DisplayName("create should return 400 when sourceAccountId is null")
    void create_shouldReturn400WhenSourceAccountIdIsNull() throws Exception {
        mockMvc.perform(post("/api/transfers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"sourceAccountId\":null,\"targetAccountId\":2,\"amount\":100.00,\"date\":\"2026-07-09\"}"))
                .andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("create should return 400 when targetAccountId is null")
    void create_shouldReturn400WhenTargetAccountIdIsNull() throws Exception {
        mockMvc.perform(post("/api/transfers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"sourceAccountId\":1,\"targetAccountId\":null,\"amount\":100.00,\"date\":\"2026-07-09\"}"))
                .andExpect(status().isBadRequest());
    }
    ...
    void create_shouldReturn400WhenAmountIsNull() throws Exception {
        mockMvc.perform(post("/api/transfers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"sourceAccountId\":1,\"targetAccountId\":2,\"amount\":null,\"date\":\"2026-07-09\"}"))
                .andExpect(status().isBadRequest());
    }
    ...
    void create_shouldReturn400WhenDateIsNull() throws Exception {
        mockMvc.perform(post("/api/transfers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"sourceAccountId\":1,\"targetAccountId\":2,\"amount\":100.00,\"date\":null}"))
                .andExpect(status().isBadRequest());
    }
    ...
    @Test
    @DisplayName("update should return 400 when sourceAccountId is null")
    void update_shouldReturn400WhenSourceAccountIdIsNull() throws Exception {
        mockMvc.perform(put("/api/transfers/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"sourceAccountId\":null,\"targetAccountId\":2,\"amount\":100.00,\"date\":\"2026-07-09\"}"))
                .andExpect(status().isBadRequest());
    ...
    static class MockConfig {
        ...
        TransferMapper transferMapper() {
            return Mockito.mock(TransferMapper.class);
        }
    }
}
