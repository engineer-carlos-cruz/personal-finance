...
@ActiveProfiles("test")
@DisplayName("ExpenseCategoryController - @WebMvcTest")
class ExpenseCategoryControllerWebMvcTest {
    ...
    @BeforeEach
    void setUp() {
        Mockito.reset(expenseCategoryService, expenseCategoryMapper);
    }
    ...
    @Test
    @DisplayName("create should return 400 when name is blank")
    void create_shouldReturn400WhenNameIsBlank() throws Exception {
        mockMvc.perform(post("/api/expense-categories")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"name\":\"\",\"description\":\"Food expenses\"}"))
    ...
    @Test
    @DisplayName("update should return 400 when name is blank")
    ...
    static class MockConfig {
        ...
        ExpenseCategoryService expenseCategoryService() {
            return Mockito.mock(ExpenseCategoryService.class);
        }

        @Bean
        ExpenseCategoryMapper expenseCategoryMapper() {
            return Mockito.mock(ExpenseCategoryMapper.class);
        }
    }
}
